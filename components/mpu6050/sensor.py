    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_INT_PIN): pins.gpio_input_pin_schema,  # <--- CORREGIDO
            cv.Optional(CONF_MOTION_THRESHOLD, default=10): cv.int_,
            cv.Optional(CONF_MOTION_DURATION, default=5): cv.int_,
        }
    )
